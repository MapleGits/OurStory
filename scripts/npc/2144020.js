...
function Tutorial1() {
    if (chat == 0) {
        ...
        cm.getPlayer().getClient().getSession().write(CField.startMapEffect("Talk to me again when you are ready.", 5122005, true));
        cm.dispose();
    }
}
...
function Tutorial2() {
    if (chat == 0)
        ...
        cm.getPlayer().getClient().getSession().write(CField.startMapEffect("I've gave you a Sword that will help you to fight. \r\nTalk to me again when you have defeated the Powerful Snail.", 5122005, true));
