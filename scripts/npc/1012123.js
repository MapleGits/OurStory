...
var hairnew;
var haircolor;
var mface = [20000, 20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20012, 20013, 20014, 20015, 20016, 20017, 20018, 20019, 20020, 20021, 20022, 20023, 20024, 20025, 20026, 20027, 20028, 20029, 20030, 20031, 20032, 20036, 20037, 20040, 20043, 20044, 20045, 20046, 20047, 20048, 20049, 20050, 20052, 20053, 20055, 20056, 20057, 20058, 20059, 20060, 20061, 20068];
var mhair = [30000, 30010, 30020, 30030, 30040, 30050, 30060, 30070, 30080, 30090, 30100, 30110, 30120, 30130, 30140, 30150, 30160, 30170, 30180, 30190, 30200, 30210, 30220, 30230, 30240, 30250, 30260, 30270, 30280, 30290, 30300, 30310, 30320, 30330, 30340, 30350, 30360, 30370, 30400, 30410, 30420, 30430, 30440, 30450, 30460, 30470, 30480, 30490, 30510, 30520, 30530, 30540, 30550, 30560, 30570, 30580, 30590, 30600, 30610, 30620, 30630, 30640, 30650, 30660, 30670, 30680, 30690, 30700, 30710, 30720, 30730, 30740, 30750, 30760, 30770, 30780, 30790, 30800, 30810, 30820, 30830, 30840, 30850, 30860, 30870, 30880, 30890, 30900, 30910, 30920, 30930, 30940, 30950, 30990];
var fface = [21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007, 21008, 21009, 21010, 21011, 21012, 21013, 21014, 21015, 21016, 21017, 21018, 21019, 21020, 21021, 21022, 21023, 21024, 21025, 21026, 21027, 21028, 21029, 21030, 21031, 21033, 21034, 21035, 21036, 21038, 21041, 21042, 21043, 21044, 21045, 21046, 21047, 21048, 21049, 21052, 21053, 21054, 21055, 21056, 21057, 21058, 21062];
    ...
    if (status == 0) {    
        ...
        if (cm.getAndroidStat("GENDER") == 0) {
            if (selection == 0) {
                ...
                cm.askAndroid("Pick a hairstyle that you would like.", hairnew);
            } else if (selection == 4) {
                beauty = 5;
                hairnew = Array();
                for (var i = 0; i < royalmhair.length; i++) {
                    if (royalmhair[i] == 30010 || royalmhair[i] == 30070 || royalmhair[i] == 30080 || royalmhair[i] == 30090 || royalmhair[i] == 33140 || royalmhair[i] == 33240 || royalmhair[i] == 33180) {
                        hairnew.push(royalmhair[i]);
                    } else {
                        hairnew.push(royalmhair[i] + parseInt(cm.getAndroidStat("HAIR") % 10));
                    }
                }
                cm.askAndroid("Pick a hairstyle that you would like.", hairnew);
            } else if (selection == 1) {
                ...
                cm.askAndroid("Pick a hair color that you would like.", haircolor);
            } else if (selection == 2) {
                beauty = 3;
                facenew = Array();
                ...
                cm.askAndroid("Pick a new face that you would like.", facenew);
            } else if (selection == 3) {
                beauty = 4;
                ...
                cm.askAndroid("Pick a eye color that you would like.", colors);
            }
            ...
            if (selection == 0) {
                ...
                beauty = 5;
                hairnew = Array();
                for (var i = 0; i < royalfhair.length; i++) {
                    if (royalfhair[i] == 34160) {
                        hairnew.push(royalfhair[i]);
                    } else {
                        hairnew.push(royalfhair[i] + parseInt(cm.getAndroidStat("HAIR") % 10));
                    }
                }
                cm.askAndroid("Pick a hairstyle that you would like.", hairnew);
            } else if (selection == 1) {
                ...
                cm.askAndroid("Pick new eyes that you would like.", facenew);
            } else if (selection == 3) {
                beauty = 4;
        ...
        if (beauty == 1 || beauty == 5) {
            cm.setAndroid(hairnew[selection]);
        } else if (beauty == 2) {
            cm.setAndroid(haircolor[selection]);
        } else if (beauty == 3) {
            cm.setAndroid(facenew[selection]);
        } else if (beauty == 4) {
            cm.setAndroid(colors[selection]);
        }
        cm.dispose();
    }
}