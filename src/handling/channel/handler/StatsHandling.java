...
public class StatsHandling {
        ...
        if (chr.getRemainingAp() > 0) {
            switch (statmask) {
                ...
                case 0x800: // MP
                    ...
                    } else if (GameConstants.isDemon(job) || GameConstants.angelic(job) || GameConstants.demonAvenger(job)) { // Demon, Angelic Buster
                        return;
    ...
    public static void DistributeSP(int skillid, byte quantity, MapleClient c, MapleCharacter chr) {
        ...
        c.getPlayer().maxRiding();
        c.getPlayer().maxDA();
        c.getPlayer().dropMessage(1, "Skills maxed!");
        c.getSession().write(CWvsContext.enableActions());
    ...
    public static final void AutoAssignAP(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr) {
     //   chr.updateTick(slea.readInt());
        ...
        if (chr.getRemainingAp() == amount + amount2) {
            switch (PrimaryStat) {
                case 64:
                    if (playerst.getStr() + amount > 1500) {
                        return;
                    }
                    ...
                    break;
                case 128:
                    if (playerst.getDex() + amount > 1500) {
                        return;
                    }
                    ...
                    break;
                case 256:
                    if (playerst.getInt() + amount > 1500) {
                        return;
                    }
                    ...
                    break;
                case 512:
                    if (playerst.getLuk() + amount > 1500) {
                        return;
                    }
            ...
            switch (SecondaryStat) {
                case 64:
                    if (playerst.getStr() + amount2 > 1500) {
                        return;
                    }
                    ...
                    break;
                case 128:
                    if (playerst.getDex() + amount2 > 1500) {
                        return;
                    }
                    ...
                    break;
                case 256:
                    if (playerst.getInt() + amount2 > 1500) {
                        return;
                    }
                    ...
                    break;
                case 512:
                    if (playerst.getLuk() + amount2 > 1500) {
                        return;
                    }
